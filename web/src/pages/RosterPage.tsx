...
export const RosterPage: React.FC = () => {
  ...
  // Empty roster tutorial state
  if (!roster || roster.length === 0) {
    console.log('RENDERING EMPTY ROSTER TUTORIAL STATE');
    return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <div className="flex items-baseline justify-between flex-wrap gap-2">
              <h1 className="text-3xl font-bold text-[var(--ci-white)]">
                Roster Optimizer
              </h1>
              {healthStatus?.dataCache?.generatedAt && (
                <div className="text-xs text-gray-400">
                  Stats updated: <DataFreshnessIndicator mtime={healthStatus.dataCache.generatedAt} showAge={true} />
                </div>
              )}
            </div>
            <p className="text-[var(--ci-muted)] mt-2">
              Set up your roster to get started
            </p>
          </div>

          {/* Instructions Panel with Tooltips */}
          <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h2 className="text-lg font-semibold text-blue-900 mb-2">
              Get Started
            </h2>
            <p className="text-blue-800 mb-3">
              Add your players either by uploading a screenshot of your roster or by searching for players manually.
            </p>
              ...
              <div className="flex flex-wrap gap-4 mt-3">
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="inline-flex items-center gap-1 text-sm text-blue-700 cursor-help">
                      <span className="text-base">📸</span> Screenshot Upload <InfoIcon className="w-3 h-3" />
                    </span>
                  </TooltipTrigger>
                  <TooltipContent>
                    Fastest way! Take a screenshot of your Yahoo roster page
                    and we'll extract all your players automatically.
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="inline-flex items-center gap-1 text-sm text-blue-700 cursor-help">
                      <span className="text-base">🔍</span> Manual Search <InfoIcon className="w-3 h-3" />
                    </span>
                  </TooltipTrigger>
                  <TooltipContent>
                    Search for players one-by-one. Perfect for small rosters
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="inline-flex items-center gap-1 text-sm text-blue-700 cursor-help">
                      <span className="text-base">⚙️</span> Settings <InfoIcon className="w-3 h-3" />
                    </span>
                  </TooltipTrigger>
                  <TooltipContent>
                    After adding players, configure your league scoring settings
                    to get accurate projections and recommendations.
                  </TooltipContent>
                </Tooltip>
              </div>
            </TooltipProvider>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <h3 className="text-xl font-semibold text-[var(--ci-white)]">
                  Upload Roster Screenshot
                </h3>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="text-sm px-2 py-0.5 bg-blue-500/20 text-blue-300 rounded cursor-help">
                        Recommended
                      </span>
                    </TooltipTrigger>
                    <TooltipContent>
                      Fastest method - extracts all players in seconds!
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-[var(--ci-white)] mb-4">
          ...
          {healthStatus?.dataCache?.generatedAt && (
            <div className="mt-6 text-center text-xs text-gray-400">
              Stats updated: <DataFreshnessIndicator

...
export const RosterPage: React.FC = () => {
  ...
  if (!roster || roster.length === 0) {
    console.log('RENDERING EMPTY STATE - roster:', roster, 'length:', roster?.length);
    return (
      <div className="min-h-screen ice-rink-bg">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {/* Two-column layout: Screenshot Upload + Manual Search */}
  ...
  console.log('RENDERING ROSTER GRID - roster length:', roster.length, 'leagueProfile:', leagueProfile);

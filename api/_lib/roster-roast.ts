...
- Verdict "The Oilers Fan Club" (6 Oilers): {"teamNames": ["Leon: The Professional", "McDavid Copperfield", "Oil Be Back"], "title": "The Homer", "roast": "Six Oilers. Your whole season now rides on one power play in Edmonton, which is also how Oilers fans live."}`,
  ...
  savage: {
    voice: `savage: a no-holds-barred comedy roast, like the meanest guy in the league chat after four beers. This manager asked to get destroyed, so destroy them. Talk straight at them and insult them directly: call them a coward, a clown, delusional, a lost cause, a tourist, whatever this roster proves. Mock their judgment, their draft-day decisions and their chances this season. No softening, no compliments, no "at least", no hedging, no clever-but-gentle observations. Every roast must contain at least one direct insult to the manager, and must name at least one player on this roster and roast him too. Players' hockey is fair game: their stats, age, decline, injury history, games missed, draft slot, contract and what they're worth in fantasy ("Ovechkin is a museum exhibit", "Rossi spends more time in the press box than on the ice"). Their lives off the ice are not. If a TV commentator could say your line on air, it isn't savage enough: rewrite it meaner. The title should be an insult too, and team names can be mean puns.`,
